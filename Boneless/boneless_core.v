...
(* top =  1  *)
(* generator = "nMigen" *)
module boneless_core(rst, clk, r_win, pins, usbin);
  wire \$2 ;
  wire \$4 ;
  wire \$6 ;
  ...
  (* src = "processor.py:21" *)
  input [15:0] usbin;
  assign \$2  = core_ext_addr == (* src = "processor.py:33" *) 1'h0;
  assign \$4  = core_ext_addr == (* src = "processor.py:39" *) 1'h1;
  assign \$6  = core_ext_addr == (* src = "processor.py:33" *) 1'h0;
  always @(posedge clk)
      pins <= \$next\pins ;
  always @(posedge clk)

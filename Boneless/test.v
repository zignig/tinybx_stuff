...
module loopback(rx, clk, rst, tx);
  ...
  (* src = "/usr/local/lib/python3.6/dist-packages/nmigen-f17375a-py3.6.egg/nmigen/hdl/ir.py:343" *)
  input clk;
  (* init = 8'h00 *)
  (* src = "uart.py:386" *)
  reg [7:0] data = 8'h00;
  ...
  (* src = "uart.py:131" *)
  wire uart_tx_ready;
  assign \$1  = uart_rx_ready & (* src = "uart.py:391" *) empty;
  assign \$3  = ~ (* src = "uart.py:392" *) empty;
  assign \$5  = uart_tx_ack & (* src = "uart.py:392" *) \$3 ;
  always @(posedge clk)
      empty <= \$next\empty ;
  always @(posedge clk)
      data <= \$next\data ;
...
module rx(rx_ack, rx_data, rst, clk, rx, rx_ready);
  ...
  wire [11:0] \$6 ;
  wire \$8 ;
  (* src = "/usr/local/lib/python3.6/dist-packages/nmigen-f17375a-py3.6.egg/nmigen/hdl/dsl.py:244" *)
  ...
  (* src = "uart.py:30" *)
  wire rx_strobe;
  assign \$10  = ~ (* src = "uart.py:53" *) rx;
  assign \$12  = rx_bitno == (* src = "uart.py:76" *) 3'h7;
  assign \$14  = ~ (* src = "uart.py:90" *) rx;
  assign \$16  = ~ (* src = "uart.py:108" *) rx;
  assign \$1  = rx_counter == (* src = "uart.py:32" *) 1'h0;
  assign \$19  = rx_bitno + (* src = "uart.py:75" *) 1'h1;
  assign \$3  = rx_counter == (* src = "uart.py:33" *) 1'h0;
  assign \$6  = rx_counter - (* src = "uart.py:36" *) 1'h1;
  assign \$8  = ~ (* src = "uart.py:53" *) rx;
  always @(posedge clk)
...
module tx(tx_data, tx_ready, rst, clk, tx, tx_ack);
  ...
  (* src = "uart.py:139" *)
  wire tx_strobe;
  assign \$11  = tx_bitno + (* src = "uart.py:182" *) 1'h1;
  assign \$1  = tx_counter == (* src = "uart.py:140" *) 1'h0;
  assign \$3  = tx_counter == (* src = "uart.py:142" *) 1'h0;
  assign \$6  = tx_counter - (* src = "uart.py:145" *) 1'h1;
  assign \$8  = tx_bitno == (* src = "uart.py:183" *) 3'h7;
  always @(posedge clk)
      tx <= \$next\tx ;
  always @(posedge clk)
      fsm_state <= \$next\fsm_state ;
